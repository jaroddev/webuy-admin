...
import com.univtours.webuy.domain.Address;
import com.univtours.webuy.repository.AddressRepository;
...
/**
 * REST controller for managing {@link com.univtours.webuy.domain.Address}.
 */
@RestController
@RequestMapping("/api")
@Transactional
